        ...
        <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
                ...
                <div class="col-md-8">
                    <div class="panel panel-default">
                        <div class="panel-body">
                            <center>
                                <h3>Tambah / Hapus Mobil</h3></center>
            ...
            { ?>
                                        <tr>
                                            ...
                                            <form method="POST" action="../edit/edit_mobil.php">
                                                <td>
                                                    <input type="hidden" name="id2" id="hx" value="<?php echo $r3['m_id_mobil']; ?>">
                                                    <input type="submit" name="submit" value="Edit" class="btn btn-primary"> </td>
                                            </form>
                                            <form method="POST" action="../delete/delete_a_mobil.php">
                                                <td>
                                                    <input type="hidden" name="id1" id="hx" value="<?php echo $r3['m_id_mobil']; ?>">
                            ...
                            <div class="col-md-6">
                                <form class="form-horizontal" action="p_mobil.php" method="post" role="form">
                                    <div class="form-group">
                                        <label>Tambah Mobil</label>
                                        <td>
                                            <input class="form-control" placeholder="Transportasi" name="m_nama_mobil" type="text" autofocus=""> </td>
                                        <br>
                                        <input type="submit" value="Tambah" class="btn btn-primary" name="submit_mobil" /> </div>
                                </form>
                            </div>
                        </div>
                    </div>
