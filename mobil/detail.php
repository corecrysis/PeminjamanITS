...
$result1 = $dbh->query($query1)->fetch();
    $query2 = "select m.m_nama_barang from t_data_pinjam  p join t_mobil m on p.p_barang = m.m_id_mobil where p_id_pinjam=$idx";
                        ...
                        <div class="panel-body">
                            <fieldset>
                                <div class="form-group">
                                    ...
                                    <label>Biaya Opeerasional</label>
                                    <p>
                                        <?php echo $result1['p_harga']; ?>
                                    </p>
                                    <div class="col-md-8">
                                        ...
                                        <p> <img src="<?php echo $result1['p_tmp_pict_1']; ?>" width="30%"> </p>
                                        <label>Bukti Foto 2</label>
                                        <p> <img src="<?php echo $result1['p_tmp_pict_2']; ?>" width="30%"> </p>
                                        <label>Bukti Foto 3</label>
                                        <p> <img src="<?php echo $result1['p_tmp_pict_3']; ?>" width="30%"> </p>
                                    </div>
                                    <div class="col-md-8">
                                        <?php if($jut == 2){} else { ?>
                                            <label>Status</label>
