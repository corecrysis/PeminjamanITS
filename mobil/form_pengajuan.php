...
//           $result1 = $dbh->query($query1)->fetch();  where t_nama_mobil =''
            $query1 = "SELECT m_id_mobil, m_nama_barang FROM t_mobil ORDER BY m_nama_barang;";
            ...
            <div class="row">
                <div class="container">
                    ...
                    <form class="form-horizontal" action="p_form.php" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label class="col-md-3 control-label" for="email">Jenis Transportasi</label>
                            <div class="col-md-4">
                                <select name="p_barang" class="form-control" required>
                                    <?php foreach ( $result1 as $r1 ) 
            { ?>
                                        <option value="<?php echo $r1['m_id_mobil'] ?>">
                        ...
                        <div class="form-group">
                            <label for="email" class="col-sm-3 control-label">Biaya Operasional</label>
                            <div class="col-sm-4">
                                <input type="text" class="form-control" name="p_harga" onkeypress="checkNumber(event)"  placeholder="Masukkan nominal" > </div>
                        </div>
