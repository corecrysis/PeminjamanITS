...
session_start();
           ...
           if(isset($_POST['submit'])){
              // $tes = $_SESSION['id_admin'];
               ...
               if (is_uploaded_file($_FILES ['uploadbukti1'] ['tmp_name'])) {
               $nama_gambar = $_FILES['uploadbukti1']['name'];
		$tmp_gambar = $_FILES['uploadbukti1']['tmp_name'];
                   $rand_gambar= $rand_text.$nama_gambar;
                   $new_location1 = "img_bukti/".$rand_gambar;
               }
               if (is_uploaded_file($_FILES ['uploadbukti2'] ['tmp_name'])) {
        $nama_gambar2 = $_FILES['uploadbukti2']['name'];
		$tmp_gambar2 = $_FILES['uploadbukti2']['tmp_name'];
                   $rand_gambar2= $rand_text.$nama_gambar2;
                   $new_location2 = "img_bukti/".$rand_gambar2;
               }
               if (is_uploaded_file($_FILES ['uploadbukti3'] ['tmp_name'])) {
        $nama_gambar3 = $_FILES['uploadbukti3']['name'];
		$tmp_gambar3 = $_FILES['uploadbukti3']['tmp_name'];
	    ...
	    if (($_FILES['uploadbukti1']['size'] > 15000000000000)&&($_FILES['uploadbukti2']['size'] > 15000000000000)&&($_FILES['uploadbukti3']['size'] > 15000000000000)) {
     ...
     $hasil_jx = $result_jx['counter_fasil'];
...
$query10 = "UPDATE t_counter SET  counter_fasil = '$tambah_jx'";
