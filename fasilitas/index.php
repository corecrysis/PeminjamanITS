...
//           $result1 = $dbh->query($query1)->fetch();  where t_nama_mobil =''
           ...
           $result1 = $dbh->query($query2)->fetchAll();
        ...
        <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
           ...
           if($jut == 1){
               ?>
                            ...
                            $p_barang = $r1['t_id_fasilitas'];
                       $query_pinjam = "SELECT * FROM t_data_pinjam p where p_golongan = 'fasil' AND p_barang= '$p_barang' AND p_m_kembali >= '$p_timest' ";
