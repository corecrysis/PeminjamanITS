...
//           $result1 = $dbh->query($query1)->fetch();  where t_nama_mobil =''
            $query1 = "SELECT t_id_fasilitas, m_nama_barang FROM t_fasilitas ORDER BY m_nama_barang;";
            ...
            <div class="row">
                <div class="container">
                    ...
                    <form class="form-horizontal" action="p_form.php" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label class="col-md-3 control-label" for="email">Jenis Fasilitas</label>
                            <div class="col-md-4">
                                <select name="p_barang" class="form-control" required>
                                    <?php foreach ( $result1 as $r1 ) 
            { ?>
                                        <option value="<?php echo $r1['t_id_fasilitas'] ?>">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input type="file" name="uploadbukti1" id="exampleInputFile" required>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input type="file" name="uploadbukti2" id="exampleInputFile">
                                <p class="help-block">tipe file : .jpg ; .png : .png ; .jpg ; .jpeg </p>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input type="file" name="uploadbukti3" id="exampleInputFile">
                                <p class="help-block">tipe file : .jpg ; .png : .png ; .jpg ; .jpeg </p>
                            </div>
                        </div>
                        <br>
